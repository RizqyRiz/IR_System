...
public abstract class Document {
   ...
   */
  protected static final String stopWordsFile = "C:/Users/RizqyRiz/sem8_WIR/WIR2024/src/ir/utilities/stopwords.txt";
  /**
  ...
  protected static PaiceHuskStemmer stemmer = new PaiceHuskStemmer();
    ...
    do {
      ...
      if (stopWords.contains(nextToken) || !allLetters(nextToken))
        ...
        //nextToken = stemmer.stripAffixes(nextToken);
    	  nextToken = stemmer.stemPaiceHusk(nextToken);
